...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
    ...
    Employee findFirstByNameContainingAndSalaryGreaterThan(String partOfName, Integer salary);
    ...
    Integer modifyEmployeeName(@Param("oldName") String oldName, @Param("newName") String newName);
